...
public class Bol3_Ejer13 {
    ...
    /**
     * funcion para sacar los resultados de los dados
     * @param numeroCarasDado numero de caras del dado
     * @return numero aleatorio del dado
     */
...
public static void main(String[] args) throws Exception {
    ...
    do {
        ...
        PrintWriter fwriter = new PrintWriter(new FileWriter("./Programas/BoletinTema3/Ej13.txt", true));
...
// **13. a) Dados d20. Realizar un programa que pida al usuario su nombre y 3
